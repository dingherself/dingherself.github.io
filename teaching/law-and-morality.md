---
layout: default
title: Phil 324&#58; Law and Morality
permalink: /teaching/law-and-morality/
include: false
---

# Welcome to Phil 324: Law and Morality!
...
<p style="text-align: right; line-height: 1.4; font-size: 0.97rem;">Credit:&nbsp;<a href=" https://www.gocomics.com/agnes/2009/08/25" target="_blank" rel="noopener noreferrer">Tony Cochran</a></p>

<p style="text-align: center; padding-top: 0.125em; padding-bottom: 0.125em;">&#42;&nbsp;&nbsp;&#42;&nbsp;&nbsp;&#42;</p>

Our class is an introduction to the philosophy of law in general and feminist philosophy of law in particular. We will consider several significant philosophical issues at the intersection of law and morality and explore their jurisprudential implications. Topics will include the nature of law, judicial discretion, constitutional and statutory interpretation, civil disobedience, racial equality, gender equality, sexual harassment, reproductive freedom, and LGBTQ+ equality.
...
<script language="JavaScript" type="text/javascript">
  ...
  var t = "edu";
  var s = " ";
  document.write("<p>" + "<em>Instructor</em>: Ding" + s + "(<a href=" + "mail" + "to:" + u + arr + d + dot + t + ">" + u + arr + d + dot + t + "</a>)" + dot + s + "My research focuses on philosophical issues surrounding gender, gender equality, and trans feminism, with a view to their implications for feminist politics and antidiscrimination law. If you’ll be in town this summer, don’t be shy to say hi if you run into me at a coffee shop (okay, more realistically, a brewery) working on a new paper, “Justice, Misgendered,” where I’m hoping to argue that leading theories of transgender discrimination face a serious misgendering problem of their own, and so we should embrace instead this nice little alternative theory of mine that I think does get around the problem (or, that’s what I’ve been telling myself is the plan). My pronouns are they/them and she/her. You might see me under some other names in various university systems; ignore them. I don’t use a last name for family reasons.</p>");
</script>
...
<p style="text-align: center; padding-top: 0.125em;">&#42;&nbsp;&nbsp;&#42;&nbsp;&nbsp;&#42;</p>

<div class="dropdown" style="padding-bottom: 0.25em;">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <li><a class="dropdown-item" href="#getting-started">Getting Started</a></li>
    <li><a class="dropdown-item" href="#module-1-introduction">Module 1 - Introduction</a></li>
    <li><a class="dropdown-item" href="#module-2---natural-law-theory-and-legal-positivism-classical-defenses">Module 2 - Natural Law Theory and Legal Positivism: Classical Defenses</a></li>
    <li><a class="dropdown-item" href="#module-3---natural-law-theory-and-legal-positivism-contemporary-defenses">Module 3 - Natural Law Theory and Legal Positivism: Contemporary Defenses</a></li>
    <li><a class="dropdown-item" href="#module-4---judicial-discretion">Module 4 - Judicial Discretion</a></li>
    <li><a class="dropdown-item" href="#module-5---constitutional-and-statutory-interpretation">Module 5 - Constitutional and Statutory Interpretation</a></li>
    <li><a class="dropdown-item" href="#module-6---civil-disobedience">Module 6 - Civil Disobedience</a></li>
    <li><a class="dropdown-item" href="#module-7---the-very-intelligibility-of-sex-discrimination">Module 7 - The Very Intelligibility of Sex Discrimination</a></li>
    <li><a class="dropdown-item" href="#module-8---critiques-of-the-sex-discrimination-doctrine-intersectional-discrimination-and-structural-subordination">Module 8 - Intersectional Discrimination and Structural Subordination</a></li>
    <li><a class="dropdown-item" href="#module-9---intersectional-discrimination-sexual-orientation-and-gender-identity-discrimination-as-sex-discrimination">Module 9 - LGTBQ+ Discrimination</a></li>
    <li><a class="dropdown-item" href="#module-10---difference-and-subordination-sexual-harassment-as-sex-discrimination">Module 10 - Sexual Harassment</a></li>
    <li><a class="dropdown-item" href="#module-11---autonomy-and-equality-barriers-to-abortion-care-access-as-sex-discrimination">Module 11 - Access to Abortion Care</a></li>
    <li><a class="dropdown-item" href="#module-12---autonomy-equality-and-subordination-barriers-to-school-facilities-access-as-sex-discrimination">Module 12 - Access to School Facilities</a></li>
  </ul>
</div>
...
- Lon Fuller, *The Morality of Law* (Rev. ed. 1969), [Appendix (UA login needed for access via the university library)](http://ezproxy.library.arizona.edu/login?url=https://www.jstor.org/stable/j.ctt1cc2mds.10)
...
- *United States v. Higgs* (2021), one among a very disturbing series of death penalty cases hastily disposed of by the Supreme Court on its shadow docket

## Module 3 - Natural Law Theory and Legal Positivism: Contemporary Defenses
...
- Death Penalty and the Supreme Court’s Shadow Docket

## Module 4 - Judicial Discretion
...
- *Shinn v. Ramirez* (2022), in which the Court upheld the death sentences of two Arizona men despite evidence that their trial counsel was unconstitutionally ineffective, because their post-conviction counsel was also too unconstitutionally ineffective to raise the ineffective assistance of trial counsel claim.

## Module 5 - Constitutional and Statutory Interpretation
...
## Module 8 - Critiques of the Sex Discrimination Doctrine: Intersectional Discrimination and Structural Subordination
...
- *Sessions v. Morales-Santana* (2017), where, Justice Ginsburg, for the Court, struck down a sex discriminatory federal immigration statute and yet still rejected the petitioner’s citizenship claim.
...
- *Frappied v. Affinity Gaming Black Hawk* (10th Cir. 2020), in which the 10th Circuit considered a claim of employment discrimination on an intersectional “sex-plus-age” basis.
...
- *Toomey v. Arizona*, No. 19-cv-35 (D. Ariz.), an ongoing case challenging Arizona’s categorical exclusion of gender-affirming surgical care under its state employee health insurance plan.
