...
2. Tracker > Track Motion > Track Type > Perspective Corner Pin;
   ...
   ![Tracker_Point](Tracker_Point.png)
...
1. Draw the feature region using the shape tools;
   ...
   ![mocha_Shape_Tool](mocha_Shape_Tool.png)

   ![mocha_feature_region](mocha_feature_region.png)

2. Define the object to be tracked using the surface tool;

   ![mocha_surface](mocha_surface.png)
...
![tracking_green_screen](tracking_green_screen.png)
1. Make a copy of the original footage and arrange your layers as follows:
![traking_keying_layers](traking_keying_layers.png)   
